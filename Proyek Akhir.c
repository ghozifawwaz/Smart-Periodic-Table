...
{
    printf("\n\n\n\t _____________________________________________________________"); //Membuat tulisan seperti yang tertulis disana
    ...
    printf("\n\t|                                                             |"); //Membuat tulisan seperti yang tertulis disana
    printf("\n\t|_____________________________________________________________|"); //Membuat tulisan seperti yang tertulis disana
    printf("\n\n\n\tFull Screen Untuk Kualitas Yang Lebih Baik"); //Membuat tulisan seperti yang tertulis disana
    printf("\n\n\n\tTekan Tombol Apapun"); //Membuat tulisan seperti yang tertulis disana
    getch(); //Meminta input dari user yang akan disimpan dalam bentuk char
    while(1) //Membuat looping tidak terbatas
    {
        system("cls"); //Menghapus layar
        printf("\n\n\t\tSMART PERIODIC TABLE"); //Membuat tulisan seperti yang tertulis disana
        ...
        if(strcmp(pilih, "1") == 0) //Membuat kondisi jika input yang dimasukkan adalah 1
        {
            ...
            printf("\n\n\n\n\tJika Telah Selesai Silahkan Tekan Enter"); //Membuat tulisan seperti yang tertulis disana
        ...
        else //Membuat kondisi jika input yang dimasukkan adalah selain 1-6
        {
            ...
            printf("\n\n\tMasukkan Pilihan Hanya Dari Angka 1-6 Sesuai Menu"); //Membuat tulisan seperti yang tertulis disana
...
void nomorunsur() //Menu nomor unsur untuk menjalankan program jika user memasukkan nomor unsur
{
    while(1) // Membuat looping tidak terbatas
    {
        ...
        printf("\n\t1. Masukkan Nomor Unsur"); //Membuat tulisan seperti yang tertulis disana
        ...
        if(strcmp(pilihanMenu, "1") == 0) //Membuat kondisi jika input yang dimasukkan adalah 1
        {
            ...
            printf("\n\n\tMasukkan Nomor Hanya Dari 1-118"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Masukkan Kembali"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Tekan Enter"); //Membuat tulisan seperti yang tertulis disana
            getch(); //Menunda layar sampai user menekan enter
        }
        ...
        {
            printf("\n\n\tPilihan Anda Salah"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tMasukkan Hanya Angka 1 atau 2 Sesuai Menu"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Masukkan Pilihan Kembali"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Tekan Enter"); //Membuat tulisan seperti yang tertulis disana
            getch(); //Menunda layar sampai user menekan enter
        }
...
void simbolunsur() //Menu simbol unsur untuk menjalankan program jika user memasukkan simbol unsur
{
    while(1) // Membuat looping tidak terbatas
    {
        system("cls"); //Memnghapus layar
        printf("\n\n\tSilahkan Pilih Menu di Bawah : "); //Membuat tulisan seperti yang tertulis disana
        printf("\n\t1. Masukkan Simbol Unsur"); //Membuat tulisan seperti yang tertulis disana
        printf("\n\t2. Kembali ke Menu Utama"); //Membuat tulisan seperti yang tertulis disana
        printf("\n\tPilihan Anda : "); //Membuat tulisan seperti yang tertulis disana
        gets(pilihanMenu); //Meminta input dari user yang akan disimpan dalam bentuk char
        if(strcmp(pilihanMenu, "1") == 0) //Membuat kondisi jika input yang dimasukkan adalah 1
        {
            ...
            printf("\n\n\tMasukkan Sesuai Contoh Yang Diberikan"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Masukkan Kembali"); //Membuat tulisan seperti yang tertulis disana
            printf("\n\n\tSilahkan Tekan Enter"); //Membuat tulisan seperti yang tertulis disana
...
void namaunsur() //Menu nomor unsur untuk menjalankan program jika user memasukkan nama unsur
{
    while(1) // Membuat looping tidak terbatas
    {
        system("cls"); //Memnghapus layar
        printf("\n\n\tSilahkan Pilih Menu di Bawah : "); //Membuat tulisan seperti yang tertulis disana
        printf("\n\t1. Masukkan Nama Unsur"); //Membuat tulisan seperti yang tertulis disana
        printf("\n\t2. Kembali ke Menu Utama"); //Membuat tulisan seperti yang tertulis disana
        printf("\n\tPilihan Anda : "); //Membuat tulisan seperti yang tertulis disana
        gets(pilihanMenu); //Meminta input dari user yang akan disimpan dalam bentuk char
        if(strcmp(pilihanMenu, "1") == 0) //Membuat kondisi jika input yang dimasukkan adalah 1
